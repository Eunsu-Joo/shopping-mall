...
const ProductDetail=() => {
    return <section className="w-screen h-screen flex items-center justify-center"> <div className="flex items-stretch md:items-center justify-center min-h-full text-center md:px-2 lg:px-4">
                <div
                          ...
                          <span aria-hidden="true"
                                        ...
                                        <div className="mt-10">
                                            ...
                                            <fieldset className="mt-4">
                                                ...
                                                <div className="grid grid-cols-4 gap-4">
                                                    ...
                                                    <label
                                                        className="group relative border rounded-md py-3 px-4 flex items-center justify-center text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none sm:flex-1 bg-gray-50 text-gray-200 cursor-not-allowed">
                            ...
                            <svg className="absolute inset-0 w-full h-full text-gray-200 stroke-2" viewBox="0 0 100 100"
                              ...
                              <line x1="0" y1="100" x2="100" y2="0" vector-effect="non-scaling-stroke"/>
                                        ...
                                        <button type="submit"
                                                className="mt-6 w-full bg-indigo-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Add
                                            to bag
                                        </button>
                                    </form>
                                </section>
